...
//
//     final googleMapSearchModel = googleMapSearchModelFromJson(jsonString);

import 'dart:convert';

GoogleMapSearchModel googleMapSearchModelFromJson(String str) =>
    GoogleMapSearchModel.fromJson(json.decode(str));

String googleMapSearchModelToJson(GoogleMapSearchModel data) =>
